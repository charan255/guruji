...
import { ArrowLeft, TrendingUp, AlertCircle, Map, Target, CheckCircle, XCircle, Shuffle } from 'lucide-react';

const CareerDetails = ({ career, onBack }) => {
            ...
            <header className="glass-card" style={{ marginBottom: '2rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '2rem' }}>
                    <div>
                        ...
                        <p style={{ fontSize: '1.2rem', opacity: 0.8, maxWidth: '600px' }}>{career.description}</p>
                    </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 2fr) 1fr', gap: '2rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                    ...
                    <div className="glass-card">
                        <h3 style={{ fontSize: '1.25rem', marginBottom: '1rem' }}>Transition Options</h3>
                        <ul style={{ paddingLeft: '1.2rem', opacity: 0.9, lineHeight: '1.6' }}>
                            <li>Part-time Bootcamp</li>
                            <li>Internal Transfer</li>
                            <li>Freelance side-gigs</li>
                        </ul>
                    </div>
                </div>
